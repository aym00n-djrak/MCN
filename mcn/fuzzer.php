...
<div class="flex">
        ...
        <div class="p-7 text-white bg-[#0f1621] flex-auto text-center">
            <div>
                <h1 class="text-4xl sm:text-5xl md:text-6xl font-[Raleway] text-center">ffuf</h1>
                </br>
                <form action="#" method="post">
                    <input type="text" name="site" placeholder="site" class="bg-gray-800 text-white p-3 ml-5">
                    <input type="text" name="port" placeholder="Entrez le port" class="bg-gray-800 text-white p-3 ml-5">
                ...
                if (isset($_POST['submit'])) {
                    ...
                    echo "<p>Domain: $site</p>";
                    echo "<p>Result: </p>";
                    echo "<p>";
                    $output = shell_exec("ffuf -u ".$site."/FUZZ -e .php -w /usr/share/wordlists/dirbuster/directory-list-2.3-medium.txt
                    ");
