    ...
    <div class=" flex-auto bg-gray-800 h-auto p-5 pt-8 w-64 rounded">
        ...
        <div class="p-7 text-white bg-[#0f1621] flex-auto text-center">
            <div>
                ...
                <p>
                    La commande <span class="text-[#FF82FF]">ipconfig</span> est une commande Windows qui permet d'afficher les informations de configuration réseau de votre ordinateur. Elle permet de connaître l'adresse IP, le masque de sous-réseau, la passerelle par défaut, le serveur DNS, le nom de la carte réseau, etc.
                </p>
                </br>

                <p>
                    C'est une commande très utile pour vérifier que votre ordinateur est correctement connecté à Internet. Elle permet également de vérifier que votre ordinateur est correctement configuré pour accéder à Internet.
                </p>
                </br>

                <p>
                    Le résultat de la commande <span class="text-[#FF82FF]">ipconfig</span> est le suivant : (C'est le resultat du serveur apache sur lequel tourne l'outil pédagogique)
                </p>
