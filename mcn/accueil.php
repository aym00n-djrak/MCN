    ...
    <div class="flex">
        ...
        <div class="p-7 text-white bg-[#0f1621] flex-auto text-center">
            <div>
                ...
                <!--hover to binary -->
                <p class="text-xl">Ce site web a été créé dans le but de vous aider à apprendre les bases de la sécurité informatique.</p>

                <p class="text-xl">Vous trouverez ici des commandes pour les systèmes d'exploitation <a href="https://www.microsoft.com/fr-fr/windows" class="text-[#FF82FF]">Windows</a> et <a href="https://www.formatux.fr/formatux-fondamentaux/module-010-presentation/index.html" class="text-[#FF82FF]">Linux</a>.</p>
                </br>
                ...
                <p class="text-xl"> Vous trouverez également des exercices pour vous entraîner sur <a href="rootme.php" class="text-[#FF82FF]">Root-me</a>, <a href="https://www.codingame.com/start" class="text-[#FF82FF]">Codingame</a> et <a href="https://scratch.mit.edu/" class="text-[#FF82FF]">Scratch</a>.</p>
