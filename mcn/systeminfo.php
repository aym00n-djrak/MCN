...
<div class="flex bg-[#0f1621]">
    <div class=" flex-auto bg-gray-800 h-auto p-5 pt-8 w-64 rounded">
        ...
        <div  class="p-7 text-white bg-[#0f1621] flex-auto text-center">
            <div>
                <h1 class="text-4xl sm:text-5xl md:text-6xl font-[Raleway] text-center">Systeminfo:</h1>

                <p>
                    La commande systeminfo est une commande qui permet d’afficher des informations sur le système d’exploitation.
                </p>
                </br>
                <p>
                    Pour l’utiliser, il suffit de taper systeminfo dans la console.
                </p>
                </br>

                <p>
                    Voici un exemple d’utilisation de la commande systeminfo : (C'est votre machine !)
                </p>
                </br>
