...
<body>
    <div class="flex">
        ...
        <div class="p-7 text-white bg-[#0f1621] flex-auto text-center">
            <div>
                <h1 class="text-4xl sm:text-5xl md:text-6xl font-[Raleway] text-center">NsLookUp</h1>
                </br>

                <p>
                    <h2 class="text-2xl sm:text-2xl md:text-2xl font-[Raleway] text-center">Nslookup est un utilitaire de ligne de commande qui permet de résoudre les noms de domaine</p><p> en adresses IP et inversement. Il est disponible sur la plupart des systèmes d'exploitation.</h2>
                </p>
                </br>

                <p>
                    Avec la commande <span class="text-[#FF82FF]">nslookup</span> on peut faire des requêtes DNS pour obtenir des informations sur un nom de domaine ou une adresse IP.
                </p>
                </br>

                <p>
                    Vous pouvez l'essayer en rentrant un nom de domaine dans la barre de recherche ci-dessous:  (exemple : <span class="text-[#FF82FF]">google.com</span>)
                </p>
                </br>
                ...
                <form action="nslookup.php" method="post">
                    <input type="text" name="domain" placeholder="Domain" class="bg-gray-800 text-white  p-3 ml-5">
                    <input type="submit" name="submit" value="Submit" class="bg-[#FF82FF] text-black rounded-lg p-2">
                </form>
