...
<div class="flex bg-[#0f1621]">
    <div class=" flex-auto bg-gray-800 h-auto p-5 pt-8 w-64 rounded">
        ...
        <div class="p-7 text-white bg-[#0f1621] flex-auto text-center">
            <div>
                <h1 class="text-4xl sm:text-5xl md:text-6xl font-[Raleway] text-center">Tree:</h1>
                <br />
                <p>Affiche l'arborescence des fichiers et dossiers du serveur apache.</p>
                <br />
                <p>
                    Pour effectuer cette commande, vous pouvez lancer votre terminal est taper la commande suivante : <span class="text-[#FF82FF]">tree</span>
                </p>
                </br>
                ...
                $tree = shell_exec("tree $dir");
                //print output and fix encoding
                echo "<pre>" . utf8_encode($tree) . "</pre>";
                ?>
