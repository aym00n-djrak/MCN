...
<body>
    <div class="flex">
        ...
        <div class="p-7 text-white bg-[#0f1621] flex-auto text-center">
            <div>
                <h1 class="text-4xl sm:text-5xl md:text-6xl font-[Raleway] text-center">Root-me:</h1>
                <br />
                <p> Root-me est un site qui permet de tester ses compétences en sécurité informatique. Il propose des challenges de différents niveaux, allant du niveau débutant au niveau expert. </p>
                <p> Le site est accessible à l'adresse suivante : <a href="https://www.root-me.org/" class="text-blue-500">https://www.root-me.org/</a> </p>
                <!--ajoute le logo rootme-->
                <a href="https://www.root-me.org/"><img src="images/rootme.png" width="200" height="200"></a>
                <p> Pour vous inscrire, il vous suffit de cliquer sur le bouton "Inscription" en haut à droite de la page d'accueil. </p>
                <p> Une fois inscrit, vous pouvez commencer à résoudre les challenges. </p>
                <br />
                <p> Je vous conseille de commencer par les challenges de niveau débutant, puis de passer aux challenges de niveau intermédiaire. </p>
                <p> Pour les challenges de niveau expert, il faut déjà avoir une bonne expérience en sécurité informatique. </p>
                <br />
                <p> C'est une platforme qui demande du temps et de la patience, mais travailler et prendre le temps de comprendre les challenges vous permettra d'apprendre beaucoup de chose. </p>
                <p> Je vous souhaite bonne chance ! </p>
